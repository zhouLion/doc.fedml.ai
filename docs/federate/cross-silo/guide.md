...
![image](../_img/cross-silo/mlops_workflow_new.png) \
...
![image](../_img/cross-silo/mlops_create_application.png)
...
![image](../_img/cross-silo/mlops_edge_devices.png)
...
![image](../_img/cross-silo/mlops_invite_collaborators.png)
...
![image](../_img/cross-silo/mlops_group_management.png)
...
![image](../_img/cross-silo/mlops_start_run.png)
...
- monitoring device status (including logging in each device) and training progress
  ![image](../_img/cross-silo/mlops_experimental_tracking_status.png)

- visualizing training results
  ![image](../_img/cross-silo/mlops_experimental_tracking_curve.png)

- visualizing system performance
  ![image](../_img/cross-silo/mlops_experimental_tracking_system.png)

- model downloading/serving
  ![image](../_img/cross-silo/model_download.jpg)
...
- distributed logging
  ![image](../_img/cross-silo/mlops_experimental_tracking_logging.png)
